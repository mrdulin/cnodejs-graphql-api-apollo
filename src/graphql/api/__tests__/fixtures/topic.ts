...
export const mockGetTopicsFailureResponse = {
  success: false,
  data: [1, 2],
};

export const mockGetTopicByIdSuccessResponse = {
  success: true,
  data: {
    ...
    last_reply_at: '2019-11-19T02:52:32.313Z',
    good: true,
    top: false,
    reply_count: 95,
    visit_count: 117093,
